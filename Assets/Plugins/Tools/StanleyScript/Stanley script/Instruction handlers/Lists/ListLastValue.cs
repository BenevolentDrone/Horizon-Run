...
{
	public class ListLastValue
		: AStanleyInstructionHandler
	{
		public ListLastValue(
		...
		public override string Instruction => StanleyOpcodes.OP_LIST_LASTVAL;
			...
			string[] instructionTokens)
		{
			...
			var result = list.LastValue;

			if (result == null)
			{
				currentLogger?.LogError(
					GetType(),
					$"COULD NOT GET LAST VALUE IN LIST");
