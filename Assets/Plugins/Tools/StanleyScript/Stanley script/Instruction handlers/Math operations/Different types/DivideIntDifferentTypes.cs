...
{
	public class DivideIntDifferentTypes
		: AStanleyInstructionHandler
	{
		public DivideIntDifferentTypes(
		...
		public override string Instruction => StanleyOpcodes.OP_DIVIDE_INT;
