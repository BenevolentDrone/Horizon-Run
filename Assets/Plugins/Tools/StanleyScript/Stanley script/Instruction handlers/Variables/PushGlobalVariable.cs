...
{
	public class PushGlobalVariable
		: AStanleyInstructionHandler
	{
		public PushGlobalVariable(
		...
		public override string Instruction => StanleyOpcodes.OP_PUSH_VARIABLE_GLOBAL;
			...
			string[] instructionTokens)
		{
			...
			if (!stack.GlobalScope.Variables.TryGetVariable(
				variableName,
				out var variable))
			{
				currentLogger?.LogError(
