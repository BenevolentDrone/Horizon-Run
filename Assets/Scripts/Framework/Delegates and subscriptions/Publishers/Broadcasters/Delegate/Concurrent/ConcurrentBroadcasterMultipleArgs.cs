...
{
	public class ConcurrentBroadcasterMultipleArgs
		: IPublisherMultipleArgs,
		  ISubscribableMultipleArgs,
		  ICleanuppable,
		  IDisposable
	{
		private readonly ConcurrentBroadcasterGeneric<object[]> innerBroadcaster;

		public ConcurrentBroadcasterMultipleArgs(
			ConcurrentBroadcasterGeneric<object[]> innerBroadcaster)
		{
