			...
			TValue value)
		{
			try
			{
				...
				else
				{
					...
					//THIS SERIALIZER IS USED IN A FILE SINK IN A LOGGER
					//NOW THE LOG IS GETTING LOGGED
					//IT GOES ALL THE WAY OVER HERE
					//AND INSTEAD OF BEING PUSHED DOWN THE LINE TO THE FORMAT SERIALIZER
					//THIS LINE GOES "NAH, IMMA LOG FIRST"
					//AND GUESS WHAT?
					//IT GOES TO THE LOGGER
					//TO THE FILE SINK
					//OVER HERE
					//AND INSTEAD OF BEING PUSHED DOWN THE LINE TO THE FORMAT SERIALIZER
					//THIS LINE GOES "NAH, IMMA LOG FIRST"
					//YOU SEE THE RECURSION AND STACK OVERFLOW?
					//THE POINT IS
					//I NEED TO FIGURE OUT HOW TO PREVENT THIS FROM HAPPENING
					//UNTIL THEN THE PERSISTENCE AINT GETTING ANY LOGGERS
					logger?.Log(
						GetType(),
