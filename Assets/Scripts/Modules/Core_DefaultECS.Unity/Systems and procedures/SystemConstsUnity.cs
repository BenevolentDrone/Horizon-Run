namespace HereticalSolutions.Modules.Core_DefaultECS
{
	public static class SystemConstsUnity
	{
		...
		public const string UPDATE_PACKAGE_INSTALLER_ID = "Update.Root";

		public const string FIXED_UPDATE_PACKAGE_INSTALLER_ID = "FixedUpdate.Root";

		public const string LATE_UPDATE_PACKAGE_INSTALLER_ID = "LateUpdate.Root";
