namespace HereticalSolutions.Modules.Core_DefaultECS
{
	public static class SystemConstsDefaultECS
	{
		...
		public const string SIMULATION_WORLD_INITIALIZATION_ROOT_INSTALLER_ID = "Simulation.Init.Root";

		public const string SIMULATION_WORLD_RESOLVE_ROOT_INSTALLER_ID = "Simulation.Resolve.Root";

		public const string SIMULATION_WORLD_DEINITIALIZATION_ROOT_INSTALLER_ID = "Simulation.Deinit.Root";
		...
		public const string VIEW_WORLD_INITIALIZATION_ROOT_INSTALLER_ID = "View.Init.Root";

		public const string VIEW_WORLD_RESOLVE_ROOT_INSTALLER_ID = "View.Resolve.Root";

		public const string VIEW_WORLD_DEINITIALIZATION_ROOT_INSTALLER_ID = "View.Deinit.Root";
		...
		public const string EVENT_WORLD_ROOT_INSTALLER_ID = "Event.Root";
