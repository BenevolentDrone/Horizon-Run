...
namespace HereticalSolutions.Templates.Universal.Factories
{
	public static class UniversalTemplateEntityFactory
	{
		public static UniversalTemplateEntityManager BuildUniversalTemplateEntityManager(
			...
			ILoggerResolver loggerResolver = null)
		{
			...
			return new UniversalTemplateEntityManager(
				allocateIDDelegate,
